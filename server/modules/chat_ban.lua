...
local description = 'Bans a player. If a reason is provided, it is used as the ban message.'

local hook = require 'nbamHook'

hook.Add('postinit', Tag, function()
	nBAM:RegisterChatCMD(Tag, usage, description, function (player, cmd, _, target, ban_msg)
